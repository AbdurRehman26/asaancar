...
export default function SignupPage() {
    ...
    if (step === 'complete') {
        return (
            <div className="flex min-h-screen items-center justify-center bg-neutral-50 dark:bg-gray-900">
                <div className="w-full max-w-md rounded-xl bg-white p-8 text-center shadow-lg dark:bg-gray-800/80">
                    <h2 className="mb-4 text-2xl font-bold text-[#7e246c] dark:text-white">Account Created!</h2>
                    <p className="mb-4 text-gray-600 dark:text-gray-300">Your account has been successfully created.</p>
        ...
        return (
            <div className="flex min-h-screen flex-col md:flex-row">
                ...
                <div className="flex flex-1 flex-col justify-start bg-white px-6 py-12 pt-3 md:justify-center md:pt-0 dark:bg-gray-900">
                    <div className="mx-auto w-full max-w-md">
                        <div className="mb-6 hidden md:block">{playStoreBanner}</div>
                        <h1 className="mb-2 text-2xl font-bold text-gray-900 dark:text-white">Set Password (Optional)</h1>
        ...
        <div className="flex min-h-screen flex-col md:flex-row">
            ...
            <div className="flex flex-1 flex-col justify-start bg-white px-6 py-12 pt-3 md:justify-center md:pt-0 dark:bg-gray-900">
                <div className="mx-auto w-full max-w-md">
                    <div className="mt-12">
                        <div className="mb-6 hidden md:block">{playStoreBanner}</div>
                        <p className="mb-6 text-gray-500 dark:text-gray-300">Create your account</p>
                        ...
                        <form onSubmit={handleSendOtp} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full rounded-lg border border-[#7e246c] bg-gray-50 px-4 py-3 text-base focus:border-[#7e246c] focus:ring-2 focus:ring-[#7e246c] dark:bg-gray-800 dark:text-white"
            ...
            <div className="relative hidden flex-1 flex-col items-center justify-center bg-white p-12 md:flex dark:bg-gray-900">
                <div className="w-full max-w-lg text-center">
                    <h2 className="mb-4 text-3xl font-bold text-gray-900 dark:text-white">Join AsaanCar Today</h2>
