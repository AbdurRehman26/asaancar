...
import { DashboardEmptyState, DashboardHero, DashboardPage, DashboardPanel } from '@/components/dashboard-shell';
        ...
        <ErrorBoundary>
            <DashboardPage>
                <DashboardHero
                    eyebrow="Inbox"
                    title="Inquiries"
                    description="Review customer messages, store-specific leads, and general inquiries in a cleaner, easier-to-scan inbox."
                />
                {/* Store Selection Dropdown */}
                {isSuperAdmin && userStores.length > 0 && (
                    <DashboardPanel title="Store filter" description="Focus the inbox on one store or review everything together.">
                        ...
                        <select
                            ...
                            className="w-full max-w-xs rounded-2xl border border-[#7e246c]/15 bg-[#fcf8fd] px-3 py-3 text-gray-900 focus:border-[#7e246c] focus:ring-2 focus:ring-[#7e246c] dark:border-white/10 dark:bg-white/5 dark:text-white"
                        >
                ...
                <DashboardPanel
                    title="Inquiry feed"
                    description="Customer messages and inquiries from your website."
                    actions={
                        <div className="flex items-center gap-2">
                            ...
                            <select
                                ...
                                className="rounded-xl border border-[#7e246c]/15 bg-[#fcf8fd] px-3 py-2 text-gray-900 dark:border-white/10 dark:bg-white/5 dark:text-white"
                            >
                ...
                >
                    {inquiries.length === 0 ? (
                        <DashboardEmptyState
                            ...
                            description="When customers contact you through the website, their messages will appear here."
                        />
                    ) : (
