  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-50 dark:bg-gray-900">
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800/80 rounded-xl shadow-lg p-8 max-w-md w-full">
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-300">Enter your store name and city to get started, or skip for now.</p>
        ...
        <div className="mb-6">
          <label className="block mb-1 font-medium text-gray-700 dark:text-gray-200">City</label>
          <select value={city} onChange={e => setCity(e.target.value)} required className="w-full px-4 py-2 rounded border border-[#7e246c] bg-gray-50 dark:bg-gray-900 dark:text-white focus:ring-2 focus:ring-[#7e246c] focus:border-[#7e246c]">
