        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 py-6">
            ...
            <div className="grid grid-cols-1 gap-8">
                <div>
                    ...
                    <div className="rounded-2xl bg-white/80 dark:bg-gray-800/80 border border-gray-100 dark:border-neutral-800 shadow-lg p-6 md:p-10 mt-6">
                        {carLoading ? (
...
export function Messages() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 py-6">
            <div className="rounded-2xl bg-white/80 dark:bg-gray-800/80 border border-gray-100 dark:border-neutral-800 shadow-lg p-0 h-full min-h-[500px] flex flex-col overflow-hidden">
                <h2 className="text-xl font-bold text-[#7e246c] dark:text-white mb-0 px-8 pt-8 pb-4">Messages</h2>
                <div className="flex flex-1 min-h-0">
                    {/* Conversation List */}
                    <div className="w-80 min-w-[220px] max-w-xs border-r border-gray-200 dark:border-neutral-700 bg-white/80 dark:bg-gray-900 h-full overflow-y-auto">
...
export function Home() {
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 py-6">
            <div className="rounded-2xl bg-white/80 dark:bg-gray-800/80 border border-gray-100 dark:border-neutral-800 shadow-lg p-10 text-center">
