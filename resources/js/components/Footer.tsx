...
const Footer: React.FC = () => (
    <footer className="mt-8 border-t border-neutral-200 bg-white py-2 dark:border-neutral-800 dark:bg-gray-800/80">
        <div className="mx-auto max-w-7xl px-6">
            <div className="flex flex-col items-center justify-between gap-1 md:flex-row">
                ...
                <div className="flex gap-6">
                    <a href="/" className="text-sm text-[#7e246c] hover:text-[#6a1f5c]">
                        Home
                    </a>
                    ...
                    <a href="/contact" className="text-sm text-[#7e246c] hover:text-[#6a1f5c]">
                        Contact Us
                    </a>
                </div>
                <div className="flex flex-col items-center gap-0.5 md:items-end">
                    ...
                    >
                        <img src="/google-play-download-android-app-logo.svg" alt="Get it on Google Play" className="h-20 w-auto sm:h-24" />
                    </a>
                    <div className="text-xs text-[#7e246c]">© {new Date().getFullYear()} AsaanCar. All rights reserved.</div>
