...
class PickAndDropResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'start_area' => $this->start_area ?: ($this->relationLoaded('pickupArea') && $this->pickupArea ? $this->pickupArea->name : null),
            'start_area_google_id' => $this->start_area_google_id,
            'start_place_id' => $this->start_place_id,
            'start_latitude' => $this->start_latitude,
            'start_longitude' => $this->start_longitude,
            'end_location' => $this->end_location,
            'end_area' => $this->end_area ?: ($this->relationLoaded('dropoffArea') && $this->dropoffArea ? $this->dropoffArea->name : null),
            'end_area_google_id' => $this->end_area_google_id,
