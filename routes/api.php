...
use App\Http\Controllers\V1\VehicleMakeController;
...
Route::middleware('auth')->group(function (){
   Route::get('{VehicleType}/vehicle-make', [VehicleAttributeController::class, 'getVehicleMakes']);
   Route::get('{VehicleMake}/vehicle-model', [VehicleAttributeController::class, 'getVehicleModels']);
